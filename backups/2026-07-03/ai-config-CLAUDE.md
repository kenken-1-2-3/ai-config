...
- `ops/` is the session operating system: [diagnosis](ops/diagnosis.md), [model dispatch](ops/model-dispatch.md), [judgment rubrics](ops/judgment-rubrics.md), [delegation templates](ops/delegation-templates.md), [projects overview](ops/projects-overview.md), [letter to future sessions](ops/letter-to-future-sessions.md).
